...
<div class="container">
    <div class="row mt-5">
        <div class="box1 col-lg-8">
            ...
            <button type="button" class="btn btn-light col-4 offset-4 mt-4">ランダム生成！</button>
            <div class="col-4 mt-4"></div>

            <!-- <div class="row"> -->
            <textarea class="col-4 mt-4" id="top_word"></textarea>
            <input type="text" name="nakasiti" max-length="14" placeholder="七文字の句を入力" class="col-4 mt-4">
            <textarea class="col-4 mt-4" id="bot_word"></textarea>
            <a class="btn btn-light col-4 offset-4 mt-4 mb-5" href="result">作成！</a>
        </div>
</div>
<!-- </div> -->
